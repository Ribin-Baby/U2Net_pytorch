...
* used for for salient object detection, image segmentation, background removal and other image2image modeling tasks.
<div  align="center">
...
*  Example: we have trained an image background removal model on [P3M-10k](https://paperswithcode.com/dataset/p3m-10k) dataset, and the results are given below.
<div  align="center">
<img  src="docs/example_u2net_Segment.png"  style="width: 60%">
<br>
<figcaption><i>Fig.3 - image bg-removal with U2-Net example</i></figcaption>
</div>
<br>

![training progress](docs/training_progress.gif)
<figcaption><i>Fig.4 - image bg-removal with U2-Net training progress after each steps</i></figcaption>
